...
PRODUTOS_BASE = [
    ...
    "CADERNETA 9X13 - COURO SINTÉTICO", "CADERNETA 14X21 - COURO SINTÉTICO", "REVISTA 9X13 - COURO SINTÉTICO", "REVISTA 14X21 - COURO SINTÉTICO", "REVISTA 19X25 - COURO SINTÉTICO", "PLANNER WIRE-O A5 - COURO SINTÉTICO",
    "FICHARIO A5 - COURO SINTÉTICO", "FICHARIO 17X24 - COURO SINTÉTICO", "CADERNO WIRE-O 17X24 - COURO SINTÉTICO",
    "CADERNO WIRE-O 20X28 - COURO SINTÉTICO", "BLOCO WIRE-O 12X20 - COURO SINTÉTICO", "CADERNO ORGANIZADOR A5 - COURO SINTÉTICO",
...
CSV_MAP_IMPRESSAO = {
    ...
    'FICHARIO A5': f'{BASE_URL_GITHUB}tabela_impressao_17x24.csv',
    ...
    'BLOCO WIRE-O 12X20': f'{BASE_URL_GITHUB}tabela_impressao_14x21.csv',
    'CADERNO WIRE-O 17X24': f'{BASE_URL_GITHUB}tabela_impressao_17x24.csv',
    'CADERNO ORGANIZADOR A5': f'{BASE_URL_GITHUB}tabela_impressao_17x24.csv',
